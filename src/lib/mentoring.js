...
export const mentoringContents = {
  ...
  expansions: [{
    ...
    content: dedent`
      ...
      2. El formulario contendrá preguntas (cortas) acerca de tu motivación por participar en este proyecto, además de los temas que te interesan conversar.
    ...
    content: dedent`
      ...
      * Durante la inscripción podrás indicar tu disponibilidad para que los estudiantes te contacten durante los meses o semanas que más te acomoden.
      ...
      * Tu nombre, motivaciones y tema a conversar aparecerán en una página web a la que tendrán acceso los estudiantes para explorar los distintos perfiles de personas con quienes pueden pedir mentorías. Esta información estará en la página por seis meses.
